...
Every day, your team will rotate one individual to be the PM. This person's responsibilities:

- Run the standup
- Set the day's agenda and goals
- Manage the project's punch-list
- Ensure that all code is properly shepherded through the workflow
- Ensure that there is a working deployment
- Document the current status/operations in the project README
- Complete the project summary report
- Help the coders in any way possible, where needed
- Be the liaison between the team and the instructional staff
- Leave a suggested agenda for the next day

**Our Production Schedule:**

- Thursday: Team Mechanics (Project Prep 1, 2, 3)
- Saturday: Wireframes and Planning (Project Prep 4)
- Monday: Milestone 1 - Basic app with database: deployment and proof of life
- Tuesday: Development
- Wednesday: Development
- Thursday: Development
- **Saturday: MVP**
- Monday: Styling, UX, Fidelity, Stretch Goals
- Tuesday: Styling, UX. Fidelity, Stretch Goals
  - **CODE FREEZE**
- Wednesday: Practice, Polish, Wrap-Up
- Thursday: Presentations

**Development Notes**

Every day, there are 2 assignments due

- Personal Retro (what did I do, how do I think it went)
- Group Retro - State of the team. To Be Completed by the PM

At the end, there are 2 summary assignments

- Individual Report
- Group Report (Google Form)
  - Need the deployed URL and the Repo, or we cannot give the group a grade!
